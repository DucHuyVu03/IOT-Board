...
//—--------- BEGIN: Lấy RTC từ nguồn server NTP hay DHK  ------------//
//MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM
...
#ifdef debug
    Serial.println("Đang lấy RTC từ server DHK...");
#endif
...
#ifdef debug                      
  Serial.println("--------------------------------------------------");
        Serial.println("Thời thực lấy từ server DHK: ");
...
#ifdef debug
    Serial.println("Không có WiFi để kết nối vào server DHK để lấy RTC");
#endif
  }
